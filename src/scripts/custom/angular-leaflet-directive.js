// This is a very slightly customized version of https://github.com/tombatossals/angular-leaflet-directive (version "0.7.6")
// Instead of using L.Map it uses L.mapbox.map
    ...
    function ($q, leafletData, leafletMapDefaults, leafletHelpers, leafletEvents) {
      ...
      return {
        ...
        link: function (scope, element, attrs) {
          ...
          // kevinh FIXME - don't bind in this map key
          var map = new L.mapbox.map(element[0], "kevin3dr.hokdl9ko", leafletMapDefaults.getMapCreationDefaults(attrs.id));
